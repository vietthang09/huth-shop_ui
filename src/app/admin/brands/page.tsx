  ...
  return (
    <div>
      ...
      <div className="w-[500px] mt-10 text-sm text-gray-800">
        {isListLoading ? (
          ...
          <div className="flex flex-col">
            {brandList.length === 0 && <div>Không có thương hiệu nào!</div>}
            {brandList.map((brand) => (
              <div
                key={brand.id}
          ...
          content={
            <div className="flex flex-col gap-4 py-10 px-3">
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Tên thương hiệu:</span>
                <Input
                  className="w-[200px]"
                  type="text"
                  value={editValue}
      ...
      {showDelete && (
        <Popup
          width="300px"
          content={<div className="text-center py-3 pb-6">Bạn có chắc chắn không?</div>}
          isLoading={isLoading}
