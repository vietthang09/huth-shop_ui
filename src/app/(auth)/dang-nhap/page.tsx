      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-2">
        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white shadow-2xl rounded-2xl px-8 py-10 space-y-8 animate-loginFadeInUp border border-gray-100">
            <h2 className="text-center font-bold text-3xl text-black">Đăng nhập</h2>
            <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div>
                  <div className="relative">
                    <Input
                      ...
                      className={`
                      login-input w-full px-4 py-3 rounded-xl transition-all duration-200
                ...
                <div>
                  <div className="relative">
                    <Input
                      ...
                      className={`
                      login-input w-full px-4 py-3 pr-12 rounded-xl transition-all duration-200
                      text-gray-900 placeholder-gray-400 
                      focus:outline-none focus:ring-0
                      ${
                        errors.password
              ...
              {/* Submit Button */}
              <Button type="submit" isLoading={isLoading} disabled={isLoading || !isValid} className="w-full">
