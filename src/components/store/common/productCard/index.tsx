  ...
  if (mainColor === "red")
    return (
      ...
      >
        ...
        <button
          className={`w-8 h-8 p-2 absolute top-2 right-2 text-red-500 bg-white rounded-full flex items-center justify-center`}
        >
          <Heart />
        </button>
      ...
      >
        ...
        <div className="z-10 w-full h-full">
          ...
          <div className="z-20 p-3 space-y-2 bg-linear-to-b from-black/10 to-black">
            <span className="inline-block text-lg font-medium text-white">{name}</span>
            <p
              className={`text-green-400 border border-green-400 px-3 py-[2px] font-medium text-xs w-fit rounded-full`}
            >
              Giải trí
            </p>
            <div className="flex items-center">
